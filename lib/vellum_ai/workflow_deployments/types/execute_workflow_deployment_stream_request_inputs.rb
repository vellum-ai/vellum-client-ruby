...
module Vellum
  module WorkflowDeployments
    class ExecuteWorkflowDeploymentStreamRequestInputs
...
#  ExecuteWorkflowDeploymentStreamRequestInputs
      ...
      # @return [Vellum::WorkflowDeployments::ExecuteWorkflowDeploymentStreamRequestInputs]
  ...
  item = item.to_json
  Vellum::WorkflowRequestInputRequest.from_json(json_object: item)
end
else
  return nil
end
