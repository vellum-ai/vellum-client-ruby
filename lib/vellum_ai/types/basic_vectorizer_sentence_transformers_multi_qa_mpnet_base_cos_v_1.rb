...
# Basic vectorizer for sentence-transformers/multi-qa-mpnet-base-cos-v1.
  class BasicVectorizerSentenceTransformersMultiQaMpnetBaseCosV1
  ...
  # @return [Object] 
    ...
    # @return [Vellum::BasicVectorizerSentenceTransformersMultiQaMpnetBaseCosV1]
...
#  BasicVectorizerSentenceTransformersMultiQaMpnetBaseCosV1 to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
