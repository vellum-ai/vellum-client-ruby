...
module Vellum
  ...
  # @return [Object] 
    ...
    def initialize(parent: OMIT, links: OMIT, workflow_definition:, type:, span_id:, additional_properties: nil)
      ...
      @_field_set = { "parent": parent, "links": links, "workflow_definition": workflow_definition, "type": type, "span_id": span_id }.reject do | _k, v |
  v == OMIT
end
    end
