...
require_relative "node_execution_fulfilled_body"
require "date"
...
module Vellum
  class NodeExecutionFulfilledEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NodeExecutionFulfilledEvent]
...
# Deserialize a JSON object to an instance of NodeExecutionFulfilledEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::NodeExecutionFulfilledBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of NodeExecutionFulfilledEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
