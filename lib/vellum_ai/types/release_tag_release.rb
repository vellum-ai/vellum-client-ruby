...
module Vellum
  ...
  # @return [Object] 
    ...
    # @return [Vellum::ReleaseTagRelease]
...
# Deserialize a JSON object to an instance of ReleaseTagRelease
    #
...
# Serialize an instance of ReleaseTagRelease to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
