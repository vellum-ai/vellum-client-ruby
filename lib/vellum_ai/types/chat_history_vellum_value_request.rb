...
# A value representing Chat History.
  class ChatHistoryVellumValueRequest
  # @return [String] 
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @return [Vellum::ChatHistoryVellumValueRequest]
...
# Deserialize a JSON object to an instance of ChatHistoryVellumValueRequest
    #
...
# Serialize an instance of ChatHistoryVellumValueRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
