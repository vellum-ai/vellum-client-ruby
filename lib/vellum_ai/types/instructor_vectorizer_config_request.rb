...
# Configuration for using an Instructor vectorizer.
  class InstructorVectorizerConfigRequest
  # @return [String] 
...
# Deserialize a JSON object to an instance of InstructorVectorizerConfigRequest
    #
...
# Serialize an instance of InstructorVectorizerConfigRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
