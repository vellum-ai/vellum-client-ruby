...
# A base Vellum primitive value representing a document.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::DocumentVellumValue]
...
# Deserialize a JSON object to an instance of DocumentVellumValue
    #
...
# Serialize an instance of DocumentVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
