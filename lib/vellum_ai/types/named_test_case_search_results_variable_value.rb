...
# Named Test Case value that is of type SEARCH_RESULTS
  class NamedTestCaseSearchResultsVariableValue
  # @return [String] 
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NamedTestCaseSearchResultsVariableValue]
...
# Serialize an instance of NamedTestCaseSearchResultsVariableValue to a JSON
#  object
    #
    # @return [String]
    def to_json
