...
module Vellum
  class TerminalNodeStringResult
    ...
    # @return [TerminalNodeStringResult]
    ...
    # Deserialize a JSON object to an instance of TerminalNodeStringResult
    #
    ...
    # Serialize an instance of TerminalNodeStringResult to a JSON object
    #
    # @return [JSON]
    def to_json(*_args)
