...
# Deserialize a JSON object to an instance of CodeExecutorInput
    ...
    def self.from_json(json_object:)
      ...
      when "SECRET"
        member = Vellum::CodeExecutorSecretInput.from_json(json_object: json_object)
      else
        member = Vellum::StringInput.from_json(json_object: json_object)
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      when "SECRET"
        Vellum::CodeExecutorSecretInput.validate_raw(obj: obj)
      else
...
# For Union Types, is_a? functionality is delegated to the wrapped member.
    ...
    # @param member [Vellum::CodeExecutorSecretInput] 
    # @return [Vellum::CodeExecutorInput]
