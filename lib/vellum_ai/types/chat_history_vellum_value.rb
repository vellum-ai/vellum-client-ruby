...
# A value representing Chat History.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::ChatHistoryVellumValue]
...
# Deserialize a JSON object to an instance of ChatHistoryVellumValue
    #
...
# Serialize an instance of ChatHistoryVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
