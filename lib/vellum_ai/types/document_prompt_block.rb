...
# A block that represents a document in a prompt template.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::DocumentPromptBlock]
    def initialize(state: OMIT, cache_config: OMIT, src:, metadata: OMIT, additional_properties: nil)
      @state = state if state != OMIT
      @cache_config = cache_config if cache_config != OMIT
      @src = src
      @metadata = metadata if metadata != OMIT
      @additional_properties = additional_properties
      @_field_set = { "state": state, "cache_config": cache_config, "src": src, "metadata": metadata }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of DocumentPromptBlock
    #
...
# Serialize an instance of DocumentPromptBlock to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
