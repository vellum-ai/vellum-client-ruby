...
# A user input representing a Vellum Workspace Secret value
  ...
  # @return [Object] 
    ...
    # @return [Vellum::CodeExecutorSecretInput]
...
# Deserialize a JSON object to an instance of CodeExecutorSecretInput
    #
...
# Serialize an instance of CodeExecutorSecretInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
