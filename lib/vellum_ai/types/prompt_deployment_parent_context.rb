...
module Vellum
  ...
  # @return [Object] 
    ...
    def initialize(parent: OMIT, links: OMIT, span_id:, deployment_id:, deployment_name:, deployment_history_item_id:, release_tag_id:, release_tag_name:, external_id: OMIT, metadata: OMIT, prompt_version_id:, additional_properties: nil)
