...
require_relative "workflow_execution_snapshotted_body"
require "date"
...
module Vellum
  class WorkflowExecutionSnapshottedEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::WorkflowExecutionSnapshottedEvent]
...
# Deserialize a JSON object to an instance of WorkflowExecutionSnapshottedEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::WorkflowExecutionSnapshottedBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of WorkflowExecutionSnapshottedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
