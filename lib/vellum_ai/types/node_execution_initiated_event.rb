...
require_relative "node_execution_initiated_body"
require "date"
...
module Vellum
  class NodeExecutionInitiatedEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NodeExecutionInitiatedEvent]
...
# Deserialize a JSON object to an instance of NodeExecutionInitiatedEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::NodeExecutionInitiatedBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of NodeExecutionInitiatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
