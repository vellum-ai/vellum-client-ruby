...
#  executed.
    ...
    def initialize(id: OMIT, name:, label:, status: OMIT, environment: OMIT, created: OMIT, last_deployed_on:, last_deployed_history_item_id:, input_variables:, output_variables:, description: OMIT, additional_properties: nil)
      @id = id if id != OMIT
      @name = name
      @label = label
