...
# A block that represents a function call in a prompt template.
  ...
  # @return [Object] 
    ...
    def initialize(state: OMIT, cache_config: OMIT, id: OMIT, name:, arguments:, additional_properties: nil)
      ...
      @_field_set = { "state": state, "cache_config": cache_config, "id": id, "name": name, "arguments": arguments }.reject do | _k, v |
  v == OMIT
end
    end
