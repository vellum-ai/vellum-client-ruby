...
module Vellum
  class UpsertTestSuiteTestCaseRequest
...
# Deserialize a JSON object to an instance of UpsertTestSuiteTestCaseRequest
    #
...
# Serialize an instance of UpsertTestSuiteTestCaseRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
