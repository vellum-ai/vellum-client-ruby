...
require_relative "folder_entity"
require "ostruct"
require "json"

module Vellum
  class PaginatedFolderEntityList
  # @return [Integer] 
    attr_reader :count
  # @return [String] 
    attr_reader :next_
  ...
  # @return [Array<Vellum::FolderEntity>] 
    attr_reader :results
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vellum::FolderEntity>] 
...
# Deserialize a JSON object to an instance of PaginatedFolderEntityList
    #
  ...
  item = item.to_json
  Vellum::FolderEntity.from_json(json_object: item)
end
      new(
        count: count,
        next_: next_,
...
# Serialize an instance of PaginatedFolderEntityList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
