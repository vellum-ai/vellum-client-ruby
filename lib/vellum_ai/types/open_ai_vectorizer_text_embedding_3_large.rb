...
# OpenAI vectorizer for text-embedding-3-large.
  class OpenAiVectorizerTextEmbedding3Large
  ...
  # @return [Object] 
    ...
    # @return [Vellum::OpenAiVectorizerTextEmbedding3Large]
...
# Deserialize a JSON object to an instance of OpenAiVectorizerTextEmbedding3Large
    #
...
# Serialize an instance of OpenAiVectorizerTextEmbedding3Large to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
