...
# Deserialize a JSON object to an instance of SearchResultMetaSource
    #
    ...
    def self.from_json(json_object:)
      ...
      when "PDF"
        member = Vellum::PdfSearchResultMetaSource.from_json(json_object: json_object)
      else
        member = Vellum::PdfSearchResultMetaSource.from_json(json_object: json_object)
      end
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      when "PDF"
        Vellum::PdfSearchResultMetaSource.validate_raw(obj: obj)
      else
...
# For Union Types, is_a? functionality is delegated to the wrapped member.
    ...
    # @param member [Vellum::PdfSearchResultMetaSource] 
    # @return [Vellum::SearchResultMetaSource]
    def self.pdf(member:)
