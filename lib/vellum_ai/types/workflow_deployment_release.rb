...
module Vellum
  ...
  # @return [Object] 
    ...
    def initialize(id: OMIT, created: OMIT, environment:, created_by: OMIT, workflow_version:, deployment:, description: OMIT, release_tags:, reviews:, additional_properties: nil)
      @id = id if id != OMIT
