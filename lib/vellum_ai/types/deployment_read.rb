...
#  * `PRODUCTION` - Production
    ...
    def initialize(id: OMIT, created: OMIT, label:, name:, status: OMIT, environment: OMIT, last_deployed_on:, input_variables:, description: OMIT, active_model_version_ids: OMIT, last_deployed_history_item_id:, additional_properties: nil)
      @id = id if id != OMIT
