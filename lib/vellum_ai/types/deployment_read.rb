...
module Vellum
  class DeploymentRead
    attr_reader :id, :created, :label, :name, :status, :environment, :last_deployed_on, :input_variables,
                :active_model_version_ids, :additional_properties
    ...
    # @param active_model_version_ids [Array<String>] Deprecated. The Prompt execution endpoints return a `prompt_version_id` that could be used instead.
