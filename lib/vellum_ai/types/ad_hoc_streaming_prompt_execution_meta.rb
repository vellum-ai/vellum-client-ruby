...
#  request opted into with `expand_meta`.
  class AdHocStreamingPromptExecutionMeta
  # @return [Integer] 
    attr_reader :latency
...
# Deserialize a JSON object to an instance of AdHocStreamingPromptExecutionMeta
    #
...
# Serialize an instance of AdHocStreamingPromptExecutionMeta to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
