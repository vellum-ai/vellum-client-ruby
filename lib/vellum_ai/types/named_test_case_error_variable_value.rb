...
# Named Test Case value that is of type ERROR
  class NamedTestCaseErrorVariableValue
  # @return [String] 
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NamedTestCaseErrorVariableValue]
...
# Deserialize a JSON object to an instance of NamedTestCaseErrorVariableValue
    #
...
# Serialize an instance of NamedTestCaseErrorVariableValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
