...
# Basic vectorizer for intfloat/multilingual-e5-large.
  class BasicVectorizerIntfloatMultilingualE5LargeRequest
  ...
  # @return [Object] 
    ...
    # @return [Vellum::BasicVectorizerIntfloatMultilingualE5LargeRequest]
...
# Serialize an instance of BasicVectorizerIntfloatMultilingualE5LargeRequest to a
#  JSON object
    #
    # @return [String]
    def to_json
