...
# A list of chat message content items.
  ...
  # @return [Array<Vellum::ArrayChatMessageContentItemRequest>] 
    attr_reader :value
  ...
  # @return [Object] 
    ...
    # @param value [Array<Vellum::ArrayChatMessageContentItemRequest>] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vellum::ArrayChatMessageContentRequest]
...
# Deserialize a JSON object to an instance of ArrayChatMessageContentRequest
  ...
  item = item.to_json
  Vellum::ArrayChatMessageContentItemRequest.from_json(json_object: item)
end
