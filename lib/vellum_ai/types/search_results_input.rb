...
# A user input representing a search results value
  ...
  # @return [Object] 
    ...
    # @return [Vellum::SearchResultsInput]
...
# Deserialize a JSON object to an instance of SearchResultsInput
    #
...
# Serialize an instance of SearchResultsInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
