...
# A block that holds a plain text string value.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::PlainTextPromptBlock]
    def initialize(state: OMIT, cache_config: OMIT, text:, additional_properties: nil)
      @state = state if state != OMIT
      @cache_config = cache_config if cache_config != OMIT
      @text = text
      @additional_properties = additional_properties
      @_field_set = { "state": state, "cache_config": cache_config, "text": text }.reject do | _k, v |
  v == OMIT
end
    end
# Deserialize a JSON object to an instance of PlainTextPromptBlock
    #
...
# Serialize an instance of PlainTextPromptBlock to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
