...
require_relative "create_test_suite_test_case_request"
require "ostruct"
require "json"

module Vellum
# A bulk operation that represents the creation of a Test Case.
  class TestSuiteTestCaseCreateBulkOperationRequest
...
#  information about the operation's success in the response.
    # @param data [Vellum::CreateTestSuiteTestCaseRequest] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vellum::TestSuiteTestCaseCreateBulkOperationRequest]
...
#  TestSuiteTestCaseCreateBulkOperationRequest
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::CreateTestSuiteTestCaseRequest.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
# Serialize an instance of TestSuiteTestCaseCreateBulkOperationRequest to a JSON
#  object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::CreateTestSuiteTestCaseRequest.validate_raw(obj: obj.data)
    end
  end
end