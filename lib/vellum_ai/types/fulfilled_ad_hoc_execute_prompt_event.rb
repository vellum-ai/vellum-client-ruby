...
require_relative "ad_hoc_fulfilled_prompt_execution_meta"
require "ostruct"
require "json"
...
#  resolved values from the model can be found.
  class FulfilledAdHocExecutePromptEvent
...
# Deserialize a JSON object to an instance of FulfilledAdHocExecutePromptEvent
    #
  ...
  Vellum::PromptOutput.from_json(json_object: item)
      ...
      unless parsed_json["meta"].nil?
        ...
        meta = Vellum::AdHocFulfilledPromptExecutionMeta.from_json(json_object: meta)
      else
        meta = nil
      end
      new(
...
# Serialize an instance of FulfilledAdHocExecutePromptEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
