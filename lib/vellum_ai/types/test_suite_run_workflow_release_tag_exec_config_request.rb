...
# Execution configuration for running a Test Suite against a Workflow Deployment
  ...
  # @return [String] 
    attr_reader :type
  # @return [Vellum::TestSuiteRunWorkflowReleaseTagExecConfigDataRequest] 
    attr_reader :data
...
#  cases within the test suite will be run by default.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param data [Vellum::TestSuiteRunWorkflowReleaseTagExecConfigDataRequest] 
...
#  cases within the test suite will be run by default.
    ...
    # @return [Vellum::TestSuiteRunWorkflowReleaseTagExecConfigRequest]
...
# Serialize an instance of TestSuiteRunWorkflowReleaseTagExecConfigRequest to a
#  JSON object
    #
    # @return [String]
    def to_json
