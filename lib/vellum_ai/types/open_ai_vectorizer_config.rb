...
# Deserialize a JSON object to an instance of OpenAiVectorizerConfig
    #
...
# Serialize an instance of OpenAiVectorizerConfig to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
