...
require_relative "node_execution_resumed_body"
require "date"
...
module Vellum
  class NodeExecutionResumedEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NodeExecutionResumedEvent]
...
# Deserialize a JSON object to an instance of NodeExecutionResumedEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::NodeExecutionResumedBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of NodeExecutionResumedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
