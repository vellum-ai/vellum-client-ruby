...
require_relative "workflow_execution_fulfilled_body"
require "date"
...
module Vellum
  ...
  # @return [Object] 
    ...
    # @return [Vellum::WorkflowExecutionFulfilledEvent]
...
# Deserialize a JSON object to an instance of WorkflowExecutionFulfilledEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::WorkflowExecutionFulfilledBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of WorkflowExecutionFulfilledEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
