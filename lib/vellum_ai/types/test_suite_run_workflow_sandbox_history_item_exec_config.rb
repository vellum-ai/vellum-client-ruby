...
require_relative "test_suite_run_workflow_sandbox_history_item_exec_config_data"
require "ostruct"
require "json"
...
#  History Item
  class TestSuiteRunWorkflowSandboxHistoryItemExecConfig
  # @return [String] 
    attr_reader :type
...
#  cases within the test suite will be run by default.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param data [Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigData] 
...
#  cases within the test suite will be run by default.
    ...
    # @return [Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfig]
...
#  TestSuiteRunWorkflowSandboxHistoryItemExecConfig
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigData.from_json(json_object: data)
      else
        data = nil
      end
...
# Serialize an instance of TestSuiteRunWorkflowSandboxHistoryItemExecConfig to a
#  JSON object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigData.validate_raw(obj: obj.data)
