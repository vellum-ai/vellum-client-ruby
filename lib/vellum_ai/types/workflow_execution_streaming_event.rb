...
require_relative "workflow_execution_streaming_body"
require "date"
...
module Vellum
  ...
  # @return [Object] 
    ...
    # @return [Vellum::WorkflowExecutionStreamingEvent]
...
# Deserialize a JSON object to an instance of WorkflowExecutionStreamingEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::WorkflowExecutionStreamingBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of WorkflowExecutionStreamingEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
