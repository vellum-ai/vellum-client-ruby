...
module Vellum
  class FolderEntityTestSuiteData
  # @return [String] 
    attr_reader :id
  # @return [String] 
    attr_reader :label
  ...
  # @return [Object] 
    ...
    def initialize(id:, label:, created:, modified:, status:, additional_properties: nil)
      @id = id
      @label = label
      @created = created
      @modified = modified
      ...
      @_field_set = { "id": id, "label": label, "created": created, "modified": modified, "status": status }
    end
# Deserialize a JSON object to an instance of FolderEntityTestSuiteData
    #
...
# Serialize an instance of FolderEntityTestSuiteData to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
