...
# A base Vellum primitive value representing a document.
  class DocumentVellumValueRequest
  # @return [String] 
    attr_reader :type
  ...
  # @return [Object] 
    ...
    # @return [Vellum::DocumentVellumValueRequest]
...
# Deserialize a JSON object to an instance of DocumentVellumValueRequest
    #
...
# Serialize an instance of DocumentVellumValueRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
