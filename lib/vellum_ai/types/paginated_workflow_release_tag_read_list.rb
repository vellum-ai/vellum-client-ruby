...
require_relative "workflow_release_tag_read"
require "ostruct"
require "json"

module Vellum
  class PaginatedWorkflowReleaseTagReadList
  # @return [Integer] 
    attr_reader :count
  # @return [String] 
    attr_reader :next_
  ...
  # @return [Array<Vellum::WorkflowReleaseTagRead>] 
    attr_reader :results
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vellum::WorkflowReleaseTagRead>] 
...
# Deserialize a JSON object to an instance of PaginatedWorkflowReleaseTagReadList
    #
  ...
  item = item.to_json
  Vellum::WorkflowReleaseTagRead.from_json(json_object: item)
end
      new(
        count: count,
        next_: next_,
...
# Serialize an instance of PaginatedWorkflowReleaseTagReadList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
