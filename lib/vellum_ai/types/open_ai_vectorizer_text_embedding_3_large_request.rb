...
# OpenAI vectorizer for text-embedding-3-large.
  class OpenAiVectorizerTextEmbedding3LargeRequest
  ...
  # @return [Object] 
    ...
    # @return [Vellum::OpenAiVectorizerTextEmbedding3LargeRequest]
...
# Serialize an instance of OpenAiVectorizerTextEmbedding3LargeRequest to a JSON
#  object
    #
    # @return [String]
    def to_json
