...
# An Array value for a variable in a Test Case.
  class TestCaseArrayVariableValue
  # @return [String] 
...
# Deserialize a JSON object to an instance of TestCaseArrayVariableValue
    #
...
# Serialize an instance of TestCaseArrayVariableValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
