...
# A user input representing a Vellum Function Call value
  ...
  # @return [Object] 
    ...
    # @return [Vellum::FunctionCallInput]
...
# Deserialize a JSON object to an instance of FunctionCallInput
    #
...
# Serialize an instance of FunctionCallInput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::FunctionCall.validate_raw(obj: obj.value)
    end
  end
end