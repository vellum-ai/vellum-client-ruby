...
require_relative "upsert_test_suite_test_case_request_body"
require "ostruct"
require "json"
...
#  information about the operation's success in the response.
    # @param data [Vellum::UpsertTestSuiteTestCaseRequestBody] 
...
#  TestSuiteTestCaseUpsertBulkOperationRequest
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::UpsertTestSuiteTestCaseRequestBody.from_json(json_object: data)
      else
        data = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::UpsertTestSuiteTestCaseRequestBody.validate_raw(obj: obj.data)
    end
  end
end