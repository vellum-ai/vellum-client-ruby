...
# Deserialize a JSON object to an instance of ReductoChunkerConfig
    #
...
# Serialize an instance of ReductoChunkerConfig to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
