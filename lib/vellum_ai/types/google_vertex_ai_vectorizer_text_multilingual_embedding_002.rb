...
module Vellum
  class GoogleVertexAiVectorizerTextMultilingualEmbedding002
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @return [Vellum::GoogleVertexAiVectorizerTextMultilingualEmbedding002]
...
# Serialize an instance of GoogleVertexAiVectorizerTextMultilingualEmbedding002 to
#  a JSON object
    #
    # @return [String]
    def to_json
