...
# A value representing a Function Call.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::FunctionCallVellumValue]
...
# Deserialize a JSON object to an instance of FunctionCallVellumValue
    #
...
# Serialize an instance of FunctionCallVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
