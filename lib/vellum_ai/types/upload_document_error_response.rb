...
module Vellum
  class UploadDocumentErrorResponse
    attr_reader :detail, :additional_properties

    # @param detail [String]
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [UploadDocumentErrorResponse]
    ...
    # Deserialize a JSON object to an instance of UploadDocumentErrorResponse
    #
    ...
    # Serialize an instance of UploadDocumentErrorResponse to a JSON object
    #
    # @return [JSON]
    def to_json(*_args)
