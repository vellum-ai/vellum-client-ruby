...
# OpenAI vectorizer for text-embedding-ada-002.
  class OpenAiVectorizerTextEmbeddingAda002
  ...
  # @return [Object] 
    ...
    # @return [Vellum::OpenAiVectorizerTextEmbeddingAda002]
...
# Deserialize a JSON object to an instance of OpenAiVectorizerTextEmbeddingAda002
    #
...
# Serialize an instance of OpenAiVectorizerTextEmbeddingAda002 to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
