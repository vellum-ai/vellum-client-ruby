...
require_relative "workflow_execution_rejected_body"
require "date"
...
module Vellum
  ...
  # @return [Object] 
    ...
    # @return [Vellum::WorkflowExecutionRejectedEvent]
...
# Deserialize a JSON object to an instance of WorkflowExecutionRejectedEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::WorkflowExecutionRejectedBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of WorkflowExecutionRejectedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
