...
require_relative "test_suite_run_workflow_sandbox_exec_config_data_request"
require "ostruct"
require "json"

module Vellum
# Execution configuration for running a Test Suite against a Workflow Sandbox
  class TestSuiteRunWorkflowSandboxExecConfigRequest
...
#  cases within the test suite will be run by default.
  ...
  # @return [Object] 
    ...
    # @param data [Vellum::TestSuiteRunWorkflowSandboxExecConfigDataRequest] 
...
#  cases within the test suite will be run by default.
    ...
    # @return [Vellum::TestSuiteRunWorkflowSandboxExecConfigRequest]
...
#  TestSuiteRunWorkflowSandboxExecConfigRequest
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::TestSuiteRunWorkflowSandboxExecConfigDataRequest.from_json(json_object: data)
      else
        data = nil
      end
...
# Serialize an instance of TestSuiteRunWorkflowSandboxExecConfigRequest to a JSON
#  object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      Vellum::TestSuiteRunWorkflowSandboxExecConfigDataRequest.validate_raw(obj: obj.data)
