...
#  * `PRODUCTION` - Production
    ...
    def initialize(id: OMIT, created: OMIT, label:, name:, status: OMIT, environment: OMIT, last_deployed_on:, input_variables:, description: OMIT, additional_properties: nil)
      @id = id if id != OMIT
