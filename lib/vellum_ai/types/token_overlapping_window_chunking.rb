...
require_relative "token_overlapping_window_chunker_config"
require "ostruct"
require "json"

module Vellum
# Token overlapping window chunking
  class TokenOverlappingWindowChunking
  ...
  # @return [Object] 
    ...
    # @param chunker_config [Vellum::TokenOverlappingWindowChunkerConfig] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vellum::TokenOverlappingWindowChunking]
...
# Deserialize a JSON object to an instance of TokenOverlappingWindowChunking
    #
...
# Serialize an instance of TokenOverlappingWindowChunking to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
