...
module Vellum
  class GoogleVertexAiVectorizerConfig
  # @return [String] 
...
# Deserialize a JSON object to an instance of GoogleVertexAiVectorizerConfig
    #
...
# Serialize an instance of GoogleVertexAiVectorizerConfig to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
