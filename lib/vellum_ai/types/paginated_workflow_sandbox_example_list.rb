...
require_relative "workflow_sandbox_example"
require "ostruct"
require "json"

module Vellum
  class PaginatedWorkflowSandboxExampleList
  # @return [Integer] 
    attr_reader :count
  # @return [String] 
    attr_reader :next_
  ...
  # @return [Array<Vellum::WorkflowSandboxExample>] 
    attr_reader :results
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vellum::WorkflowSandboxExample>] 
...
# Deserialize a JSON object to an instance of PaginatedWorkflowSandboxExampleList
    #
...
# Serialize an instance of PaginatedWorkflowSandboxExampleList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
