...
require_relative "test_suite_run_external_exec_config_data"
require "ostruct"
require "json"
...
#  callable
  class TestSuiteRunExternalExecConfig
...
# Deserialize a JSON object to an instance of TestSuiteRunExternalExecConfig
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::TestSuiteRunExternalExecConfigData.from_json(json_object: data)
      else
        data = nil
      end
...
# Serialize an instance of TestSuiteRunExternalExecConfig to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
