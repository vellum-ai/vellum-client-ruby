...
require_relative "deployment_release_tag_read"
require "ostruct"
require "json"

module Vellum
  class PaginatedDeploymentReleaseTagReadList
  # @return [Integer] 
    attr_reader :count
  # @return [String] 
    attr_reader :next_
  ...
  # @return [Array<Vellum::DeploymentReleaseTagRead>] 
    attr_reader :results
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vellum::DeploymentReleaseTagRead>] 
...
#  PaginatedDeploymentReleaseTagReadList
  ...
  item = item.to_json
  Vellum::DeploymentReleaseTagRead.from_json(json_object: item)
end
      new(
        count: count,
        next_: next_,
...
# Serialize an instance of PaginatedDeploymentReleaseTagReadList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
