...
# Output for a test suite run metric that is of type STRING
  class TestSuiteRunMetricStringOutput
  # @return [String] 
    attr_reader :value
  # @return [String] 
    attr_reader :name
...
# Deserialize a JSON object to an instance of TestSuiteRunMetricStringOutput
    #
...
# Serialize an instance of TestSuiteRunMetricStringOutput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
