...
require_relative "workflow_release_tag_workflow_deployment_history_item"
require_relative "release_tag_release"
require "ostruct"
require "json"

module Vellum
  class WorkflowReleaseTagRead
...
#  * `USER` - User
    attr_reader :source
  # @return [Vellum::WorkflowReleaseTagWorkflowDeploymentHistoryItem] Deprecated. Reference the `release` field instead.
...
#  * `SYSTEM` - System
#  * `USER` - User
    # @param history_item [Vellum::WorkflowReleaseTagWorkflowDeploymentHistoryItem] Deprecated. Reference the `release` field instead.
...
# Deserialize a JSON object to an instance of WorkflowReleaseTagRead
    #
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["history_item"].nil?
        ...
        history_item = Vellum::WorkflowReleaseTagWorkflowDeploymentHistoryItem.from_json(json_object: history_item)
      else
        history_item = nil
      end
...
# Serialize an instance of WorkflowReleaseTagRead to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::WorkflowReleaseTagWorkflowDeploymentHistoryItem.validate_raw(obj: obj.history_item)
