...
require_relative "node_execution_paused_body"
require "date"
...
module Vellum
  class NodeExecutionPausedEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NodeExecutionPausedEvent]
...
# Deserialize a JSON object to an instance of NodeExecutionPausedEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::NodeExecutionPausedBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of NodeExecutionPausedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
