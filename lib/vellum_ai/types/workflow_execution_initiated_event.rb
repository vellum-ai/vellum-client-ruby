...
require_relative "workflow_execution_initiated_body"
require "date"
...
# Deserialize a JSON object to an instance of WorkflowExecutionInitiatedEvent
    #
...
# Serialize an instance of WorkflowExecutionInitiatedEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
