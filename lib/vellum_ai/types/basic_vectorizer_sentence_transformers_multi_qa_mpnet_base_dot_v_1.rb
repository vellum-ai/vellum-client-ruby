...
# Basic vectorizer for sentence-transformers/multi-qa-mpnet-base-dot-v1.
  class BasicVectorizerSentenceTransformersMultiQaMpnetBaseDotV1
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @return [Vellum::BasicVectorizerSentenceTransformersMultiQaMpnetBaseDotV1]
...
#  BasicVectorizerSentenceTransformersMultiQaMpnetBaseDotV1 to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
