...
require_relative "ad_hoc_rejected_prompt_execution_meta"
require "ostruct"
require "json"
...
# Deserialize a JSON object to an instance of RejectedAdHocExecutePromptEvent
    #
...
# Serialize an instance of RejectedAdHocExecutePromptEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
