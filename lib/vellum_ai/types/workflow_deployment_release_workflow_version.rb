...
module Vellum
  ...
  # @return [Object] 
    ...
    def initialize(id:, input_variables:, output_variables:, dependencies:, additional_properties: nil)
      @id = id
      @input_variables = input_variables
      @output_variables = output_variables
      @dependencies = dependencies
      @additional_properties = additional_properties
      @_field_set = { "id": id, "input_variables": input_variables, "output_variables": output_variables, "dependencies": dependencies }
    end
