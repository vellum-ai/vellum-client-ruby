...
require_relative "test_suite_test_case"
require "ostruct"
require "json"

module Vellum
  class PaginatedTestSuiteTestCaseList
  # @return [Integer] 
    attr_reader :count
  # @return [String] 
    attr_reader :next_
  ...
  # @return [Array<Vellum::TestSuiteTestCase>] 
    attr_reader :results
  ...
  # @return [Object] 
    ...
    # @param results [Array<Vellum::TestSuiteTestCase>] 
...
# Deserialize a JSON object to an instance of PaginatedTestSuiteTestCaseList
    #
  ...
  item = item.to_json
  Vellum::TestSuiteTestCase.from_json(json_object: item)
end
      new(
        count: count,
        next_: next_,
...
# Serialize an instance of PaginatedTestSuiteTestCaseList to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
