...
module Vellum
  class WorkflowSandboxParentContext
  ...
  # @return [String] 
    attr_reader :sandbox_history_item_id
  # @return [String] 
...
# Deserialize a JSON object to an instance of WorkflowSandboxParentContext
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      scenario_id = parsed_json["scenario_id"]
      new(
        parent: parent,
        links: links,
        type: type,
...
# Serialize an instance of WorkflowSandboxParentContext to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      obj.scenario_id.is_a?(String) != false || raise("Passed value for field obj.scenario_id is not the expected type, validation failed.")
    end
  end
end