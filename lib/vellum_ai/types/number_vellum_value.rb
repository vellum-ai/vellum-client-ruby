...
# A value representing a number.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NumberVellumValue]
...
# Deserialize a JSON object to an instance of NumberVellumValue
    #
...
# Serialize an instance of NumberVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
