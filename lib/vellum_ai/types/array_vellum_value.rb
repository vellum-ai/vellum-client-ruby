...
# A value representing an array of Vellum variable values.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::ArrayVellumValue]
...
# Deserialize a JSON object to an instance of ArrayVellumValue
    #
...
# Serialize an instance of ArrayVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
