...
module Vellum
  class WorkflowReleaseTagWorkflowDeploymentHistoryItem
  # @return [String] 
    attr_reader :id
  # @return [DateTime] 
  ...
  # @return [Object] 
    ...
    # @return [Vellum::WorkflowReleaseTagWorkflowDeploymentHistoryItem]
...
# Serialize an instance of WorkflowReleaseTagWorkflowDeploymentHistoryItem to a
#  JSON object
    #
    # @return [String]
    def to_json
