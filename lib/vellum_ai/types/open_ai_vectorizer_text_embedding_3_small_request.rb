...
# OpenAI vectorizer for text-embedding-3-small.
  class OpenAiVectorizerTextEmbedding3SmallRequest
  ...
  # @return [Object] 
    ...
    # @return [Vellum::OpenAiVectorizerTextEmbedding3SmallRequest]
...
# Serialize an instance of OpenAiVectorizerTextEmbedding3SmallRequest to a JSON
#  object
    #
    # @return [String]
    def to_json
