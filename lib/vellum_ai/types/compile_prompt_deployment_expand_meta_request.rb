...
module Vellum
  class CompilePromptDeploymentExpandMetaRequest
...
#  deployment.
    ...
    # @return [Vellum::CompilePromptDeploymentExpandMetaRequest]
...
# Serialize an instance of CompilePromptDeploymentExpandMetaRequest to a JSON
#  object
    #
    # @return [String]
    def to_json
