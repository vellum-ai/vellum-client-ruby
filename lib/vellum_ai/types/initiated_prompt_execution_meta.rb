...
#  request opted into with `expand_meta`.
  ...
  # @return [Object] 
    ...
    def initialize(model_name: OMIT, latency: OMIT, deployment_release_tag: OMIT, prompt_version_id: OMIT, additional_properties: nil)
      ...
      @_field_set = { "model_name": model_name, "latency": latency, "deployment_release_tag": deployment_release_tag, "prompt_version_id": prompt_version_id }.reject do | _k, v |
  v == OMIT
end
    end
