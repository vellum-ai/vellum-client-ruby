...
# A base Vellum primitive value representing audio.
  ...
  # @return [Object] 
    ...
    # @return [Vellum::AudioVellumValueRequest]
...
# Deserialize a JSON object to an instance of AudioVellumValueRequest
    #
...
# Serialize an instance of AudioVellumValueRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
