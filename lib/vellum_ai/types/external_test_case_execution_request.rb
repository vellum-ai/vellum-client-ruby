...
module Vellum
  class ExternalTestCaseExecutionRequest
  # @return [Array<Vellum::NamedTestCaseVariableValueRequest>] The output values of a callable that was executed against a Test Case outside of
#  Vellum
    attr_reader :outputs
  # @return [String] 
  ...
  # @return [Object] 
    ...
    # @param outputs [Array<Vellum::NamedTestCaseVariableValueRequest>] The output values of a callable that was executed against a Test Case outside of
#  Vellum
    # @param test_case_id [String] 
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vellum::ExternalTestCaseExecutionRequest]
...
# Deserialize a JSON object to an instance of ExternalTestCaseExecutionRequest
    #
...
# Serialize an instance of ExternalTestCaseExecutionRequest to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
