...
#  ARRAY
  class TestSuiteRunExecutionArrayOutput
  # @return [String] 
    attr_reader :name
  ...
  # @return [Object] 
    ...
    # @return [Vellum::TestSuiteRunExecutionArrayOutput]
...
# Deserialize a JSON object to an instance of TestSuiteRunExecutionArrayOutput
    #
...
# Serialize an instance of TestSuiteRunExecutionArrayOutput to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
