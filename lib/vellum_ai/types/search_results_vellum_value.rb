...
# A value representing Search Results.
  class SearchResultsVellumValue
  ...
  # @return [Object] 
    ...
    # @return [Vellum::SearchResultsVellumValue]
...
# Deserialize a JSON object to an instance of SearchResultsVellumValue
    #
...
# Serialize an instance of SearchResultsVellumValue to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
