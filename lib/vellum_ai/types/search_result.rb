...
require_relative "search_result_meta"
require "ostruct"
require "json"
...
module Vellum
  ...
  # @return [Vellum::SearchResultDocument] The document that contains the chunk that matched the search query.
    attr_reader :document
  # @return [Vellum::SearchResultMeta] Additional information about the search result.
    attr_reader :meta
  ...
  # @return [Object] 
    ...
    # @param document [Vellum::SearchResultDocument] The document that contains the chunk that matched the search query.
    # @param meta [Vellum::SearchResultMeta] Additional information about the search result.
    # @param additional_properties [OpenStruct] Additional properties unmapped to the current class definition
    # @return [Vellum::SearchResult]
...
# Deserialize a JSON object to an instance of SearchResult
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["document"].nil?
        ...
        document = Vellum::SearchResultDocument.from_json(json_object: document)
      else
        document = nil
      end
      unless parsed_json["meta"].nil?
        meta = parsed_json["meta"].to_json
        meta = Vellum::SearchResultMeta.from_json(json_object: meta)
      else
        meta = nil
      end
      new(
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::SearchResultDocument.validate_raw(obj: obj.document)
      obj.meta.nil? || Vellum::SearchResultMeta.validate_raw(obj: obj.meta)
    end
  end
end