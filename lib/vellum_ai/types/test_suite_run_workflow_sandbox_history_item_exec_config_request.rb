...
require_relative "test_suite_run_workflow_sandbox_history_item_exec_config_data_request"
require "ostruct"
require "json"
...
#  History Item
  class TestSuiteRunWorkflowSandboxHistoryItemExecConfigRequest
  # @return [String] 
    attr_reader :type
  # @return [Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigDataRequest] 
    attr_reader :data
...
#  cases within the test suite will be run by default.
  ...
  # @return [Object] 
    ...
    # @param type [String] 
    # @param data [Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigDataRequest] 
...
#  cases within the test suite will be run by default.
    ...
    # @return [Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigRequest]
...
#  TestSuiteRunWorkflowSandboxHistoryItemExecConfigRequest
    ...
    def self.from_json(json_object:)
      ...
      unless parsed_json["data"].nil?
        ...
        data = Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigDataRequest.from_json(json_object: data)
      else
        data = nil
      end
...
# Serialize an instance of TestSuiteRunWorkflowSandboxHistoryItemExecConfigRequest
#  to a JSON object
    #
    # @return [String]
    def to_json
...
#  definitions.
    ...
    def self.validate_raw(obj:)
      ...
      Vellum::TestSuiteRunWorkflowSandboxHistoryItemExecConfigDataRequest.validate_raw(obj: obj.data)
