...
require_relative "node_execution_streaming_body"
require "date"
...
module Vellum
  class NodeExecutionStreamingEvent
  ...
  # @return [Object] 
    ...
    # @return [Vellum::NodeExecutionStreamingEvent]
...
# Deserialize a JSON object to an instance of NodeExecutionStreamingEvent
    #
  ...
  Vellum::SpanLink.from_json(json_object: item)
      ...
      unless parsed_json["body"].nil?
        ...
        body = Vellum::NodeExecutionStreamingBody.from_json(json_object: body)
      else
        body = nil
      end
      id = parsed_json["id"]
...
# Serialize an instance of NodeExecutionStreamingEvent to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
