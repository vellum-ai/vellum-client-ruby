...
module Vellum
  class UpsertTestSuiteTestCaseRequestBody
  # @return [String] The Vellum-generated ID of an existing Test Case whose data you'd like to
#  replace. If specified and no Test Case exists with this ID, a 404 will be
#  returned.
    attr_reader :id
  # @return [String] An ID external to Vellum that uniquely identifies the Test Case that you'd like
#  to create/update. If there's a match on a Test Case that was previously created
#  with the same external_id, it will be updated. Otherwise, a new Test Case will
#  be created with this value as its external_id. If no external_id is specified,
#  then a new Test Case will always be created.
  ...
  # @return [Object] 
    ...
    # @param id [String] The Vellum-generated ID of an existing Test Case whose data you'd like to
#  replace. If specified and no Test Case exists with this ID, a 404 will be
#  returned.
    # @param external_id [String] An ID external to Vellum that uniquely identifies the Test Case that you'd like
#  to create/update. If there's a match on a Test Case that was previously created
#  with the same external_id, it will be updated. Otherwise, a new Test Case will
#  be created with this value as its external_id. If no external_id is specified,
#  then a new Test Case will always be created.
    ...
    # @return [Vellum::UpsertTestSuiteTestCaseRequestBody]
...
# Deserialize a JSON object to an instance of UpsertTestSuiteTestCaseRequestBody
    #
...
# Serialize an instance of UpsertTestSuiteTestCaseRequestBody to a JSON object
    #
    # @return [String]
    def to_json
      @_field_set&.to_json
